...
class Event(Base):
    ...
    points = relationship("Points", backref="the_event",cascade="save-update,merge")#ithat true?
    teams = relationship(
        "Team",
        backref = "event",
    ...
    def __init__(self,title=None,desc=None,apply_start=None,
        ...
        self.person_per_team = person_per_team
        self.prize = prize
...
class Team(Base):
    ...
    def __init__(self, score=0, urgent_contact=None, urgent_phone=None,check=0,slogan=None):
        self.score = score
        self.urgent_contact = urgent_contact
        self.urgent_phone = urgent_phone
        self.check = check
        self.slogan = slogan
